...
public:
    ...
    void startPortalNoTimeout(const char* apName, const char* apPass); // Portal without timeout
    void stopPortal(); // Stop the config portal
    ...
    String getPassword();
    void reset();
    bool isPortalActive(); // Check if portal is currently active
...
private:
    ...
    bool lastState;
    bool portalActive;
    bool portalNoTimeout;  // Flag for timeout-free portal mode
